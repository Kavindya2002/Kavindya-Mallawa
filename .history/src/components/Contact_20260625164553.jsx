...
const contactItems = [
  ...
  { icon: <Phone size={20} />, label: 'Phone', value: '+9477-6032-717', href: `tel:${personalInfo.phone}`, color: 'text-accent-500' },
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="glass-card p-6">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                  Currently seeking full-time and internship roles in software engineering and cloud development. Let's connect!
                </p>
              </div>
              ...
              <div className="glass-card p-6">
                ...
                <div className="flex gap-3">
                  {[
                    { href: personalInfo.linkedin, icon: <Linkedin size={18} />, label: 'LinkedIn', bg: 'bg-blue-600' },
                    { href: personalInfo.github, icon: <Github size={18} />, label: 'GitHub', bg: 'bg-slate-900 dark:bg-slate-100 dark:text-slate-900' },
                    { href: `mailto:${personalInfo.email}`, icon: <Mail size={18} />, label: 'Email', bg: 'bg-primary-600' },
